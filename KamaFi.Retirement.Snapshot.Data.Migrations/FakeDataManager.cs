        ...
        public IEnumerable<RetirementFact> GetRetirementFacts()
        {
            return new List<RetirementFact>
            {
                new RetirementFact
                {
                    ...
                    LongDescription = "How much can you contribute to your 401(k) per year for 2022",
                    Key = "401_k",
                    Value = "$20500",
                ...
                new RetirementFact
                {
                    ...
                    LongDescription = "How much can you contribute to your Roth IRA per year for 2022",
                    Key = "roth_ira",
                    Value = "$6500",
                    CreatedAt = DateTime.UtcNow,
                    UpdatedAt = DateTime.UtcNow,
                ...
                new RetirementFact
                {
                    ...
                    LongDescription = "Although this is a little more complicated, this is the retirement age for men in 2022",
                ...
                new RetirementFact
                {
                    ...
                    LongDescription = "Although this is a little more complicated, this is the retirement age for women in 2022",
